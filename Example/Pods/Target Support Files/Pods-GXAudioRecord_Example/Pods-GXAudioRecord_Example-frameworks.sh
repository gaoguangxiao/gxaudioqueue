...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GXAudioRecord/GXAudioRecord.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RSAdventureApi/RSAdventureApi.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RSBridgeCore/RSBridgeCore.framework"
